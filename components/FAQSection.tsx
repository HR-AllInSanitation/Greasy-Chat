      ...
      <div className="space-y-4">
        {faqs.map((faq, index) => (
          ...
          >
            ...
            >
              <h3 className="text-base lg:text-lg font-bold text-slate-900 flex-1">
                {faq.question}
              </h3>
              <div className={`w-8 h-8 rounded-full bg-white border-2 border-slate-300 flex items-center justify-center transition-all ${openIndex === index ? 'rotate-180 border-amber-500 bg-amber-50' : ''}`}>
            ...
            {openIndex === index && (
              <div className="px-6 py-6 bg-white border-t border-slate-100">
                <div 
                  className="text-slate-700 leading-relaxed space-y-3 text-sm lg:text-base"
